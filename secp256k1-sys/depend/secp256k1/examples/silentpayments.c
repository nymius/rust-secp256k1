...
int main(void) {
    ...
    /*** Sending ***/
    {
        ...
        for (i = 0; i < N_OUTPUTS; i++) { ret =
            rustsecp256k1_v0_12_ec_pubkey_parse(ctx,
    ...
    /*** Receiving ***/
    {
...

        {
            ...
            }
            {
                 ...
                 * called
                 * `rustsecp256k1_v0_12_silentpayments_recipient_create_labelled_spend_pubkey`
             ...
             * with light clients.
             */
            ret = rustsecp256k1_v0_12_silentpayments_recipient_public_data_create(ctx,
                &public_data,
                smallest_outpoint,
        ...
        }
        {
             ...
             */
            ret = rustsecp256k1_v0_12_silentpayments_recipient_public_data_parse(ctx,
                &public_data,
                light_client_data33
            );
            assert(ret);
            ...
            n_found_outputs = 0;
            {
                ...
                while (1) {
                    ret = rustsecp256k1_v0_12_silentpayments_recipient_create_output_pubkey(ctx,
                        &potential_output,
                        shared_secret,
                        &spend_pubkey,
                        k
