...
static void run_tests(rustsecp256k1_v0_12_context *ctx, unsigned char *key) {
    ...
    ret = rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_create(ctx, &prevouts_summary, outpoint_smallest, xonly_pubkeys, 1, plain_pubkeys, 1);
    CHECK(ret == 1);
     ...
     */
    CHECK(rustsecp256k1_v0_12_silentpayments_recipient_scan_outputs(ctx, found_outputs, &n_found_outputs, tx_outputs, 1, key, &prevouts_summary, &recipient.spend_pubkey, NULL, NULL));
