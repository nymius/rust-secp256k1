 ...
 *                                key
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_create_labelled_spend_pubkey(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_pubkey *labelled_spend_pubkey,
 ...
 *  transaction, `rustsecp256k1_v0_12_silentpayments_recipient_scan_outputs` should be
 *  used instead.
 *
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_create_shared_secret(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_create_output_pubkey(
    const rustsecp256k1_v0_12_context *ctx,
