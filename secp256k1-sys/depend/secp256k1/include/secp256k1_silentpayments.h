 ...
 *  be used.
 */
typedef struct rustsecp256k1_v0_12_silentpayments_recipient {
    rustsecp256k1_v0_12_pubkey scan_pubkey;
    rustsecp256k1_v0_12_pubkey spend_pubkey;
    size_t index;
} rustsecp256k1_v0_12_silentpayments_recipient;
 ...
 *                            (not rustsecp256k1_v0_12_context_static).
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_create_labeled_spend_pubkey(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_pubkey *labeled_spend_pubkey,
    const rustsecp256k1_v0_12_pubkey *unlabeled_spend_pubkey,
    const rustsecp256k1_v0_12_pubkey *label
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *  `rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_create`. Can be serialized with
 *  `rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_serialize`. The serialization is
 *  intended for storing the object or sending the prevout summary data to light clients.
 *  The serialization is parsed with
 *  `rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_parse`.
 */
typedef struct rustsecp256k1_v0_12_silentpayments_prevouts_summary {
    unsigned char data[101];
} rustsecp256k1_v0_12_silentpayments_prevouts_summary;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_create(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_serialize(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_prevouts_summary_parse(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_silentpayments_prevouts_summary *prevouts_summary,
 ...
 *  `rustsecp256k1_v0_12_silentpayments_recipient_create_label` can be used.
 *
 ...
 */
typedef const unsigned char* (*rustsecp256k1_v0_12_silentpayments_label_lookup)(const unsigned char* label33, const void* label_context);
 ...
 *                    public key.
 */
typedef struct rustsecp256k1_v0_12_silentpayments_found_output {
    rustsecp256k1_v0_12_xonly_pubkey output;
    unsigned char tweak[32];
    int found_with_label;
    rustsecp256k1_v0_12_pubkey label;
} rustsecp256k1_v0_12_silentpayments_found_output;
 ...
 *
 *  For creating the labels cache, `rustsecp256k1_v0_12_silentpayments_recipient_create_label`
 *  can be used.
 *
 ...
 *                               key is valid if it passes rustsecp256k1_v0_12_ec_seckey_verify
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_scan_outputs(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_silentpayments_found_output **found_outputs,
 ...
 *  `rustsecp256k1_v0_12_silentpayments_scan_outputs` to check if there are additional outputs
 ...
 *  In:              scan_key32: pointer to the recipient's 32 byte scan key.
 *                               The scan key is valid if it passes rustsecp256k1_v0_12_ec_seckey_verify.
 *             prevouts_summary: pointer to the transaction prevouts summary data
 *                               (see `_recipient_prevouts_summary_create`).
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_silentpayments_recipient_create_output_pubkeys(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_xonly_pubkey **outputs_xonly,
    const unsigned char *scan_key32,
    const rustsecp256k1_v0_12_silentpayments_prevouts_summary *prevouts_summary,
    const rustsecp256k1_v0_12_pubkey **spend_pubkeys,
