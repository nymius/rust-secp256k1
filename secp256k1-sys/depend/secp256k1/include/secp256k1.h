 ...
 *  rustsecp256k1_v0_12_context_create for creation of contexts and
 *  rustsecp256k1_v0_12_context_randomize for randomization.
 *
 ...
 *  rustsecp256k1_v0_12_context_set_error_callback as well as
 *  rustsecp256k1_v0_12_context_set_illegal_callback for details. Future library versions
 *  may use context objects for additional purposes.
 *
 *  A constructed context can safely be used from multiple threads
 *  simultaneously, but API calls that take a non-const pointer to a context
 *  need exclusive access to it. In particular this is the case for
 *  rustsecp256k1_v0_12_context_destroy, rustsecp256k1_v0_12_context_preallocated_destroy,
 *  and rustsecp256k1_v0_12_context_randomize.
 *
 *  Regarding randomization, either do it once at creation time (in which case
 *  you do not need any locking for the other calls), or use a read-write lock.
 */
typedef struct rustsecp256k1_v0_12_context_struct rustsecp256k1_v0_12_context;
 ...
 *  use rustsecp256k1_v0_12_ec_pubkey_serialize and rustsecp256k1_v0_12_ec_pubkey_parse. To
 *  compare keys, use rustsecp256k1_v0_12_ec_pubkey_cmp.
 */
typedef struct rustsecp256k1_v0_12_pubkey {
    unsigned char data[64];
} rustsecp256k1_v0_12_pubkey;
 ...
 *  comparison, use the rustsecp256k1_v0_12_ecdsa_signature_serialize_* and
 *  rustsecp256k1_v0_12_ecdsa_signature_parse_* functions.
 */
typedef struct rustsecp256k1_v0_12_ecdsa_signature {
    unsigned char data[64];
} rustsecp256k1_v0_12_ecdsa_signature;
 ...
 */
typedef int (*rustsecp256k1_v0_12_nonce_function)(
...
/** Context flags to pass to rustsecp256k1_v0_12_context_create, rustsecp256k1_v0_12_context_preallocated_size, and
 *  rustsecp256k1_v0_12_context_preallocated_create. */
...
/** Flag to pass to rustsecp256k1_v0_12_ec_pubkey_serialize. */
 ...
 *  binaries.
 *
 *  It is highly recommended to call this before using rustsecp256k1_v0_12_context_static.
 *  It is not necessary to call this function before using a context created with
 *  rustsecp256k1_v0_12_context_create (or rustsecp256k1_v0_12_context_preallocated_create), which will
 *  take care of performing the self tests.
 *
 *  If the tests fail, this function will call the default error callback to abort the
 *  program (see rustsecp256k1_v0_12_context_set_error_callback).
 */
SECP256K1_API void rustsecp256k1_v0_12_selftest(void);
 ...
 *  memory allocation entirely, see rustsecp256k1_v0_12_context_static and the functions in
 *  rustsecp256k1_v0_12_preallocated.h.
 *
 ...
 *  recommended to call rustsecp256k1_v0_12_context_randomize on the context before calling
 *  those API functions. This will provide enhanced protection against side-channel
 *  leakage, see rustsecp256k1_v0_12_context_randomize for details.
 *
 ...
 *  This function uses malloc to allocate memory. It is guaranteed that malloc is
 *  called at most once for every call of this function. If you need to avoid dynamic
 *  memory allocation entirely, see the functions in rustsecp256k1_v0_12_preallocated.h.
 *
 ...
 *   - void rustsecp256k1_v0_12_default_illegal_callback_fn(const char *message, void *data);
 *   - void rustsecp256k1_v0_12_default_error_callback_fn(const char *message, void *data);
 *  The library may call a default callback even before a proper callback data
 *  pointer could have been set using rustsecp256k1_v0_12_context_set_illegal_callback or
 *  rustsecp256k1_v0_12_context_set_error_callback, e.g., when the creation of a context
 ...
 *              default callback.
 *
 *  See also rustsecp256k1_v0_12_context_set_error_callback.
 */
SECP256K1_API void rustsecp256k1_v0_12_context_set_illegal_callback(
    rustsecp256k1_v0_12_context *ctx,
 ...
 *  incorrect usage of the API (see rustsecp256k1_v0_12_context_set_illegal_callback
 ...
 *              default callback, see rustsecp256k1_v0_12_context_set_illegal_callback
 *              for details).
 *        data: the opaque pointer to pass to fun above, must be NULL for the
 *              default callback.
 *
 *  See also rustsecp256k1_v0_12_context_set_illegal_callback.
 */
SECP256K1_API void rustsecp256k1_v0_12_context_set_error_callback(
    rustsecp256k1_v0_12_context *ctx,
    void (*fun)(const char *message, void *data),
    const void *data
) SECP256K1_ARG_NONNULL(1);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_pubkey_parse(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ec_pubkey_serialize(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_pubkey_cmp(
    const rustsecp256k1_v0_12_context *ctx,
    const rustsecp256k1_v0_12_pubkey *pubkey1,
    const rustsecp256k1_v0_12_pubkey *pubkey2
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ec_pubkey_sort(
    const rustsecp256k1_v0_12_context *ctx,
    const rustsecp256k1_v0_12_pubkey **pubkeys,
    size_t n_pubkeys
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_signature_parse_compact(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_signature_parse_der(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_ecdsa_signature *sig,
    const unsigned char *input,
    size_t inputlen
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_signature_serialize_der(
    const rustsecp256k1_v0_12_context *ctx,
    unsigned char *output,
    size_t *outputlen,
    const rustsecp256k1_v0_12_ecdsa_signature *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *  In:     sig:       pointer to an initialized signature object
 *
 *  See rustsecp256k1_v0_12_ecdsa_signature_parse_compact for details about the encoding.
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_signature_serialize_compact(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 * rule, apply rustsecp256k1_v0_12_ecdsa_signature_normalize to the signature prior to
 * verification, but be aware that doing so results in malleable signatures.
 *
 * For details, see the comments for that function.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ecdsa_verify(
    const rustsecp256k1_v0_12_context *ctx,
    const rustsecp256k1_v0_12_ecdsa_signature *sig,
...
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_signature_normalize(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_ecdsa_signature *sigout,
    const rustsecp256k1_v0_12_ecdsa_signature *sigin
 ...
 *                      rustsecp256k1_v0_12_nonce_function_default is used.
 *           ndata:     pointer to arbitrary data used by the nonce generation function
 *                      (can be NULL). If it is non-NULL and
 *                      rustsecp256k1_v0_12_nonce_function_default is used, then ndata must be a
 *                      pointer to 32-bytes of additional data.
 *
 * The created signature is always in lower-S form. See
 * rustsecp256k1_v0_12_ecdsa_signature_normalize for more details.
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_sign(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_ecdsa_signature *sig,
    const unsigned char *msghash32,
    const unsigned char *seckey,
    rustsecp256k1_v0_12_nonce_function noncefp,
    const void *ndata
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_seckey_verify(
    const rustsecp256k1_v0_12_context *ctx,
    const unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);
 ...
 *  In:      seckey: pointer to a 32-byte secret key.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_pubkey_create(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_pubkey *pubkey,
    const unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *           rustsecp256k1_v0_12_ec_seckey_verify. 1 otherwise
 *  Args:   ctx:    pointer to a context object
 *  In/Out: seckey: pointer to the 32-byte secret key to be negated. If the
 *                  secret key is invalid according to
 *                  rustsecp256k1_v0_12_ec_seckey_verify, this function returns 0 and
 *                  seckey will be set to some unspecified value.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_seckey_negate(
    const rustsecp256k1_v0_12_context *ctx,
 ...
 *                  invalid according to rustsecp256k1_v0_12_ec_seckey_verify, this
 *                  function returns 0. seckey will be set to some unspecified
 *                  value if this function returns 0.
 *  In:    tweak32: pointer to a 32-byte tweak, which must be valid according to
 *                  rustsecp256k1_v0_12_ec_seckey_verify or 32 zero bytes. For uniformly
 *                  random 32-byte tweaks, the chance of being invalid is
 *                  negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_seckey_tweak_add(
    const rustsecp256k1_v0_12_context *ctx,
    unsigned char *seckey,
 ...
 *                  negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_pubkey_tweak_add(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_pubkey *pubkey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                  rustsecp256k1_v0_12_ec_seckey_verify, this function returns 0. For
 *                  uniformly random 32-byte arrays the chance of being invalid
 *                  is negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_seckey_tweak_mul(
    const rustsecp256k1_v0_12_context *ctx,
    unsigned char *seckey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                  is negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_pubkey_tweak_mul(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_pubkey *pubkey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 * rustsecp256k1_v0_12_context_create or rustsecp256k1_v0_12_context_clone (or from the corresponding
 * functions in rustsecp256k1_v0_12_preallocated.h) before using these contexts to call API
 ...
 * context rustsecp256k1_v0_12_context_static is not supported.
 *
 * Currently, the random seed is mainly used for blinding multiplications of a
 * secret scalar with the elliptic curve base point. Multiplications of this
 * kind are performed by exactly those API functions which are documented to
 * require a context that is not rustsecp256k1_v0_12_context_static. As a rule of thumb,
 * these are all functions which take a secret key (or a keypair) as an input.
 * A notable exception to that rule is the ECDH module, which relies on a different
 * kind of elliptic curve point multiplication and thus does not benefit from
 * enhanced protection against side-channel leakage currently.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_context_randomize(
    rustsecp256k1_v0_12_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ec_pubkey_combine(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_pubkey *out,
    const rustsecp256k1_v0_12_pubkey * const *ins,
    size_t n
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
