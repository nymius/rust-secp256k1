 ...
 *  the rustsecp256k1_v0_12_ecdsa_signature_serialize_* and
 ...
 *  memcmp'ed.
 */
typedef struct rustsecp256k1_v0_12_ecdsa_recoverable_signature {
    unsigned char data[65];
} rustsecp256k1_v0_12_ecdsa_recoverable_signature;
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_recoverable_signature_parse_compact(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_ecdsa_recoverable_signature *sig,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_recoverable_signature_convert(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_ecdsa_signature *sig,
    const rustsecp256k1_v0_12_ecdsa_recoverable_signature *sigin
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_recoverable_signature_serialize_compact(
    const rustsecp256k1_v0_12_context *ctx,
    unsigned char *output64,
    int *recid,
    const rustsecp256k1_v0_12_ecdsa_recoverable_signature *sig
 ...
 *                      (can be NULL for rustsecp256k1_v0_12_nonce_function_default).
 */
SECP256K1_API int rustsecp256k1_v0_12_ecdsa_sign_recoverable(
    const rustsecp256k1_v0_12_context *ctx,
    rustsecp256k1_v0_12_ecdsa_recoverable_signature *sig,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_12_ecdsa_recover(
    const rustsecp256k1_v0_12_context *ctx,
